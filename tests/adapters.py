...
from cs336_basics.DataLoader import get_batch,load_checkpoint,save_checkpoint
...
def run_swiglu(
    ...
    swiglu.layer1.weight.data.copy_(w1_weight)
    swiglu.layer2.weight.data.copy_(w2_weight)
    swiglu.layer3.weight.data.copy_(w3_weight)
